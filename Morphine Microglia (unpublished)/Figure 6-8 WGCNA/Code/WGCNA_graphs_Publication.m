...
w.loadGeneTable('Z:\Neumaier Lab\Morphine Grant\RNA Seq 2\WGCNA for Publication\WGCNA Output\Gene Modules IP.csv','coolColors', 0);
...
cd('Z:\Neumaier Lab\Morphine Grant\RNA Seq 2\WGCNA for Publication\IP Results');
...
p = polyfit(center(idx),(g.Nodes.Wald_Stats(idx)),1);
y1 = polyval(p,center);
hold on
scatter(center,y1,4,'filled','o');
ylabel('Morphine Wald Statistic');
