...
clear all close all
directory=uigetdir('D:\Neumaier Lab\Pet1 RNAseq\Figure Creation Folders\Control Figure'); % Raw data
fig_fold='D:\Neumaier Lab\Pet1 RNAseq\Figure Creation Folders\Control Figure'; % Figure folder
cd(directory);
