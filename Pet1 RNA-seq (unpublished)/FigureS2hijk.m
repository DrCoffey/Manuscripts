...
clear all close all
directory=uigetdir('Z:\Neumaier Lab\Pet1 RNAseq\Figure Creation Folders\Enrichment Figure'); % Raw data
fig_fold='Z:\Neumaier Lab\Pet1 RNAseq\Figure Creation Folders\Enrichment Figure'; % Figure folder
cd(directory);
...
pngFileName = 'Enrichment DifferentialExpression.png'; % Set the File name 
...
txt = {'Overlap (2519): ';'Stressed F (642): ';'Stressed M (718): ';'Unstressed F (83): ';'Unstressed M (486): '}; % strings
...
pngFileName = 'EnrichPie.png'; % Set the File name 
fullFileName = fullfile(fig_fold, pngFileName); % Add Figure Path
export_fig(fullFileName, '-m5'); % Save the Figure

xlswrite('EnrichGenes.xlsx',UniqGenes);
